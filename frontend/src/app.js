...
/* harmony import */ var _router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./router */ "./src/assets/js/router.js");


Object(_router__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
function init() {
  ...
  router.on('/contact', function () {
    var form = '<form>';
    form += "<input name='firstName' placeholder='Your name'>";
    form += '</form>';
    document.getElementById('app').innerHTML = form;
  });
  router.on('/user/:id', function (match) {
    console.log(match);
    var data = match.data,
        params = match.params;
    console.log(params); // document.getElementById('app').innerHTML = 'Contact';
  });
  router.notFound(function () {
    console.log('not found');
    router.navigate('/'); // document.getElementById('app').innerHTML = 'Error404';
  });
  router.resolve();
}
...
/***/ 0:
/*!***************************************************!*\
  !*** multi babel-polyfill ./src/assets/js/app.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
